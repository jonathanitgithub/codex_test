                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Our selling services provide a seamless experience for those looking to sell their properties. 
                                    From strategic marketing tactics to showcasing your property's best features.
                                    </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>our rental services offer a plethora of options to suit every need and budget. Whether you're searching for a cozy apartment,
                                     a spacious family home, or a commercial space for your business.
                                     </p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p> This spacious property  with
                                     a beautifully landscaped backyard. With its convenient location, excellent schools, and nearby amenities.
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>we specialize in legal investment services, guiding clients through the intricate process of real estate investment with
                                        ...
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="p-4 d-inline-block w-100">
                                                    ...
                                                    <button type="submit" value="send message" name="send" class="btn btn-primary"> <a href="propertydetail.php">View more</a> </button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>At HomeX Real Estate, we understand that buying, selling, or renting a property is more than just a transaction — it's 
                                            a significant milestone in your life. That's why we're committed to providing an unparalleled real estate experience
                                ...
                                <li class="mb-4 text-white d-flex"> 
                                    ...
                                    <h5>Expertise You Can Trust</h5>
										<p>
                                        With years of experience in the local real estate market, our team of seasoned professionals possesses the knowledge and 
                                        expertise to guide you through every step of the process. Whether you're a first-time buyer, seasoned investor, 
                                        or homeowner looking to sell, 
                                        we have the skills to help you achieve your goals.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									<i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary" aria-hidden="true"></i>
									<div class="pl-2">
										<h5 class="mb-3">Community Commitment</h5>
										<p>As members of the community, we're deeply committed to giving back and making a positive impact. 
                                            We're not just here to sell houses — we're here to build relationships, support our neighbors,
                                             and contribute to the growth and vitality of our community.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>The process begins with an initial discussion between you and one of our experienced real estate agents. 
                                During this consultation, we take the time to understand your specific needs, preferences, and goals. Whether you're looking to buy, sell, rent, or invest in real estate,
                                 we tailor our approach to meet your unique requirements.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>When you're ready to move forward with a property, we guide you through the documentation 
                                and file review process. Our team assists you in reviewing contracts, agreements, and other legal documents to ensure 
                                that everything is in order and meets your expectations. We provide expert guidance and advice every step of the way,
                                 addressing any questions or concerns you may
                                 have</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once all the necessary paperwork is in order and you're satisfied with the terms, we facilitate the property acquisition process. 
                                Whether you're buying, selling, or renting, we handle all the logistics and negotiations on your behalf. 
                                Our goal is to make the process as 
                                smooth and stress-free as possible, allowing you to focus on enjoying your new property or investment</p>
                        </div>
                    </div>
                </div>
            </div>
